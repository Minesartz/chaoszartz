...
public class MegaTridentEntity extends PersistentProjectileEntity {
    ...
    public MegaTridentEntity(EntityType<? extends net.minecraft.entity.projectile.TridentEntity> entityType, World world) {
        super(entityType, world);
        this.tridentStack = new ItemStack(Items.TRIDENT);
    }

    public MegaTridentEntity(World world, LivingEntity owner, ItemStack stack) {
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        if (this.getWorld() instanceof ServerWorld) {
            ...
            if (this.getWorld().isSkyVisible(blockPos)) {
                ...
                for(int i = 0; i < 10; i++) {
                    TntEntity tntEntity = (TntEntity) EntityType.TNT.create(this.getWorld());
                    if (tntEntity != null) {
                        tntEntity.refreshPositionAfterTeleport(Vec3d.ofBottomCenter(blockPos));
        ...
        this.playSound(soundEvent, g, 5.0F);
    }
    ...
    protected void onBlockHit(BlockHitResult blockHitResult) {
        ...
        if (this.getWorld() instanceof ServerWorld) {
            ...
            for (int i = 0; i < 5; i++) {
                EndCrystalEntity endCrystalEntity = (EndCrystalEntity) EntityType.END_CRYSTAL.create(this.getWorld());
                if (endCrystalEntity != null) {
                    lightningEntity.refreshPositionAfterTeleport(Vec3d.ofBottomCenter(blockPos));
                    this.getWorld().spawnEntity(endCrystalEntity);
                }
            }
        }
    }
